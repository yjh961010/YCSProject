        ...
        <div id="notices">
            ...
            <table class="notice-table">
                ...
                <c:forEach var="dto" items="${noticeboardList}">
                    <tr class="notice-row">
                        ...
                        <td align="left">
                            <a href="content_noticeboard.do?num=${dto.num}" class="notice-link">${dto.subject}</a>
                        </td>
            ...
            <c:if test="${not empty noticeboardList}">
                <div class="pagination">
                    ...
                    <a href="noticeboard.do?pageNum=<%=startPage-pageBlock%>">&laquo; 이전</a>
                    <% } %>

                        <%-- 페이지 번호 출력 --%>
                    <% for (int i = startPage; i <= endPage; ++i) { %>
                    <a href="noticeboard.do?pageNum=<%=i%>" class="<%= (i == currentPage) ? "active" : "" %>"><%=i%></a>
                    <% } %>

                        <%-- 다음 페이지 링크 --%>
                    <% if (endPage < pageCount) { %>
                    <a href="noticeboard.do?pageNum=<%=startPage+pageBlock%>">다음 &raquo;</a>
                    <% } %>
                </div>
            </c:if>
        </div>
